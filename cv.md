...
- Migration du code _legacy_ vers une architecture utilisant le version de MVVM développée par Kickstarter, en Swift.
...
- Design de modèle de _machine learning_ pour évaluer les joueurs de football.
...
- [Culturebox][culturebox]/[Sourdoreille][sourdoreille] : réalisation du site
  pour la web-série de concerts [_Les Contes du Paris Perché_][parisperche]
...
- [Sourdoreille][sourdoreille] : réalisation du site web de sondage décalé
  [_Les Concerts, ce serait mieux sans_][concerts]
...
- Identification, qualification et test de services mobiles innovants pour
  l'_Orange Trial Factory_ (géolocalisation, services communautaires, etc.)
  pour Orange
...
- Le projet Droits et Terminaux comprenait la conception, la réalisation
  _from scratch_ du système de gestion des droits des abonnés Canal+, tout
